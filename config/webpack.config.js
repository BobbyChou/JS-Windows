  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        'imageCommon': path.join(__dirname, '../src/img/'),
        'componentCommon': path.join(__dirname, '../src/Components/'),
        'reducerCommon': path.join(__dirname, '../src/Store/'),
        'pageCommon': path.join(__dirname, '../src/Views/')
      },
      plugins: [
